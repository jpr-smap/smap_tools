...
% compile with:
% /misc/local/matlab-2019a/bin/mcc -mv -I ~/smappoi_min/v2.1/src/ -I ~/smappoi_min/v2.1/src/emClarity_FFT/ -R -singleCompThread smappoi_search_global.m
